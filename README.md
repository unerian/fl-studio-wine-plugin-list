...
|     ➖   | High Testing |Soundtoys Bundle                    |   -     | Older versions of these (🏴‍☠️) seem to be a bit unstable, and crash frequently. The up to date VST3 versions seem to be much more stable, so if you are going to install, install them. |
